...
#=================================================================
# R:\ModflowBinary\CBB_TermByLayer.R
#=================================================================
...
cat(paste('Establishing multiprocessor session...This may take a few seconds...\n'))
plan(multiprocess, .skip = TRUE)
cat(paste('Please look for window requesting CBB files selection \n',
          'Or it may present itself as a [feather] icon on your taskbar \n'))
#=================================================================
...
#-------------------------------------------------
# unlist results returned from FUNCTION "makeSumLayer"
#-------------------------------------------------
