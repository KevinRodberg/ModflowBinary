...
P90diffRCv40_L3 <- RC2014_P90_L3 - SIM2040_P90_L3
levelplot(raster(P90diffRCv40_L3), par.settings = yourTheme, at=c(-10,-5,-2.5,-1,.001, .1, .2, .3, .4, .5, 1, 2.5, 5,10,15))
...
diffRas<-raster::raster(P90diffRCv40_L3,rasExt[1:4], crs=HARNSP17ft)

filename = paste0('//ad.sfwmd.gov/dfsroot/data/wsd/SUP/proj/CFWI_WetlandStress/Update2018/p90headDiffLay',
                  selectLayer,'v3.tif')
